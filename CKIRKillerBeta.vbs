...
' --- STEP 4: Hancom Remove (Pure CMD) ---
MsgBox "한컴 입력기 삭제를 시작합니다..", vbInformation, "CKIRKiller"
On Error Resume Next
oShell.Run "cmd /c taskkill /F /IM HncUpdateTray.exe", 0, True
oShell.Run "cmd /c taskkill /F /IM ctfmon.exe", 0, True
oShell.Run "cmd /c reg delete ""HKCU\Software\Microsoft\CTF\SortOrder"" /f", 0, True
